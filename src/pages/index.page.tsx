  ...
  return (
    <>
      <div className="min-h-full bg-gray-800 flex flex-1 flex-col">
        ...
        <main className='flex-1'>
          <header className="py-10">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-white">Je suis Lounici Yanis,</h1>
              <h1 className="text-3xl font-bold tracking-tight text-white">Web-Developpeur en Freelance.</h1>
            </div>
          </header>
        ...
        <footer className="flex justify-center text-gray-500 dark:text-gray-400">
          <div className='text-center'>
            <p>Freelance - Lounici Yanis</p>
            <p>xeleroy@gmail.com</p>
          </div>
        </footer>
      </div>
    </>
